...
func _enter_tree():
	...
	dialogue_label.add_theme_font_size_override("bold_italics_font_size", 22)
	dialogue_label.add_theme_font_size_override("italics_font_size", 22)
	dialogue_label.add_theme_font_size_override("mono_font_size", 22)
	dialogue_label.add_theme_font_size_override("normal_font_size", 22)
