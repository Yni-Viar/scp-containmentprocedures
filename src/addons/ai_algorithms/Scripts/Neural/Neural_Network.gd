...
# Input sensors
var raycasts: Array[RayCast3D] # Array of raycasts for environment sensing
...
func get_distance(_raycast: RayCast3D):
	var distance: float = 0.0
	if _raycast.is_colliding():
		var origin: Vector3 = _raycast.global_position
		var collision: Vector3 = _raycast.get_collision_point()
